  ...
  Widget build(BuildContext context) {
    ...
    void registration(AuthController authController) {
      ...
      if (name.isEmpty) {
        ...
        showMessage("Wpisz Poprawy Adres Email",
            title: "Niepoprawy adres Email");
      } else if (password.isEmpty) {
        showMessage("Wpisz Hasło", title: "Hasło");
      } else if (password.length < 8) {
        showMessage("Hasło nie może być krótsze niż 8 znaków",
            title: "Krótkie hasło");
      } else if (!containsUppercase(password)) {
        showMessage("Hasło musi zawierać przynajmniej jedną wielką literę",
            title: "Brak wielkiej litery");
      } else if (!containsLowercase(password)) {
        showMessage("Hasło musi zawierać przynajmniej jedną małą literę",
            title: "Brak małej litery");
      } else if (!containsDigit(password)) {
        showMessage("Hasło musi zawierać przynajmniej jedną cyfrę",
            title: "Brak cyfry");
      } else if (!containsSpecialCharacter(password)) {
        showMessage("Hasło musi zawierać przynajmniej jeden znak specjalny",
            title: "Brak znaku specjalnego");
      } else {
